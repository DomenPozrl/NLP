...
if __name__ == "__main__":
    ...
    zenska_imena = pickle.load(open("extracted data/zenska_imena.pickle", "rb"))
    moska_imena = pickle.load(open("extracted data/moska_imena.pickle", "rb"))
    priimki = pickle.load(open("extracted data/priimki.pickle", "rb"))
    obcine = pickle.load(open("extracted data/obcine.pickle", "rb"))
    naselja = pickle.load(open("extracted data/kraji.pickle", "rb"))
    glavna_mesta = pickle.load(open("extracted data/glavna_mesta.pickle", "rb"))
    drzave = pickle.load(open("extracted data/drzave.pickle", "rb"))
