...
def support(classes):
    ...
    for key in sprt:
        print(key, ': {}%'.format(round(100 * sprt[key] / cnt, 2)))
...
if __name__ == '__main__':
    train_X, train_Y, test_X, test_Y = load_train_test(X_filename='../Data/experiment_5_balanced/vector_vector_znacilke.pickle',
