                    ...
                    for c1 in c1s:
                        for c2 in c2s:
                            ...
                            try:
                                ...
                                print('Accuracy: {}'.format(metrics.flat_accuracy_score(test_Y, pred_Y)))
...
def apparow(train_X, train_Y, test_X, test_Y):
    ...
    with open('results/apparow', 'wb') as file:
        pickle.dump(results, file)


if __name__ == '__main__':
    train_X, train_Y, test_X, test_Y = load_train_test(X_filename='../Data/experiment_4_morphosintactic/vector_vector_znacilke.pickle',
                                                       Y_filename='../Data/experiment_4_morphosintactic/vector_vector_classes.pickle',
                                                       train=70,
                                                       test=30)

    lbfgs(train_X, train_Y, test_X, test_Y)
    l2sgd(train_X, train_Y, test_X, test_Y)
    apparow(train_X, train_Y, test_X, test_Y)
