...
if __name__ == '__main__':
    x_folds, y_folds = cross_validation_split(x_filename='../Data/experiment_1_original/vector_vector_znacilke.pickle',
                                              y_filename='../../Data/experiment_1_original/vector_vector_classes.pickle',
                                              k=5)
...
# RESULTS:
# per: (array([0.7937706]), array([0.82490583]), array([0.80766899]))
# org: (array([0.42959627]), array([0.38373579]), array([0.394061]))
# misc: (array([0.20121212]), array([0.09277778]), array([0.12159227]))
# loc: (array([0.84141789]), array([0.81747674]), array([0.82864419]))
# not: (array([0.99832379]), array([0.99871425]), array([0.99851873]))
