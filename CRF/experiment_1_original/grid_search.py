...
def apparrow(train_X, train_Y, test_X, test_Y):
    ...
    with open('results/apparrow', 'wb') as file:
        pickle.dump(results, file)


if __name__ == '__main__':
    train_X, train_Y, test_X, test_Y = load_train_test(X_filename='../Data/experiment_1_original/vector_vector_znacilke.pickle',
    ...
    apparrow(train_X, train_Y, test_X, test_Y)
