...
if __name__ == '__main__':
    train_X, train_Y, test_X, test_Y = load_train_test(X_filename='../Data/experiment_2_strip2/vector_vector_znacilke.pickle',
                                                       Y_filename='../Data/experiment_2_strip2/vector_vector_classes.pickle',
                                                       train=70,
                                                       test=30)
